...
vi.mock("../src/metrics.js", () => ({
  ...
  calculateStats: vi.fn(() => ({
    ...
    min: { ttft: 80, totalTime: 900, totalTokens: 40, averageSpeed: 45, peakSpeed: 55, tps: [] },
    max: { ttft: 120, totalTime: 1100, totalTokens: 60, averageSpeed: 55, peakSpeed: 65, tps: [] },
    stdDev: { ttft: 10, totalTime: 50, totalTokens: 5, averageSpeed: 2, peakSpeed: 3, tps: [] },
    sampleSize: 2,
  })),
}));
